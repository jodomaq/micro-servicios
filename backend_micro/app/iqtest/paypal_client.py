...
PAYPAL_CLIENT_ID = os.getenv("IQ_PAYPAL_CLIENT_ID")
PAYPAL_CLIENT_SECRET = os.getenv("IQ_PAYPAL_CLIENT_SECRET")

# Configuración de moneda y monto base
PAYPAL_CURRENCY = os.getenv("IQ_PAYPAL_CURRENCY", "MXN")
PAYPAL_AMOUNT = os.getenv("IQ_PAYPAL_AMOUNT", "20.00")

# URL de producción. Si se requiere sandbox, usar IQ_PAYPAL_ENV=sandbox.
PAYPAL_ENV = os.getenv("IQ_PAYPAL_ENV", "live").lower()
...
async def create_order(request: OrderRequest) -> Dict[str, Any]:
    ...
    payload = {
        ...
        "application_context": {
            "return_url": os.getenv("IQ_PAYPAL_RETURN_URL", "https://micro-servicios.com.mx/iqtest/return"),
            "cancel_url": os.getenv("IQ_PAYPAL_CANCEL_URL", "https://micro-servicios.com.mx/iqtest/cancel"),
        },
    }
    async with httpx.AsyncClient() as client:
