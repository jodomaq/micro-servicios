...
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "")  # compartida con otros servicios
OPENAI_API_URL = "https://api.openai.com/v1/chat/completions"
OPENAI_TIMEOUT = float(os.getenv("IQ_OPENAI_TIMEOUT", "30"))
OPENAI_MAX_RETRIES = int(os.getenv("IQ_OPENAI_MAX_RETRIES", "2"))
OPENAI_MODEL = os.getenv("IQ_OPENAI_MODEL", "gpt-4")
